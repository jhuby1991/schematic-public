...
import { setupUI } from './ui.js?v=1.13';
import { setupCanvas } from './canvas.js?v=1.13';
import { setupPalette } from './palette.js?v=1.13';
import { setupStorage } from './storage.js?v=1.13';
import { showNotification } from './utils.js?v=1.13';
import { setupZoomPan } from './zoom.js?v=1.13';
